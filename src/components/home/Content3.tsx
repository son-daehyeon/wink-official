  ...
  return (
    ...
    >
      <div className="flex flex-col w-full md:w-[400px]">
        {subject !== null && (
          <h2 className="font-pretendard text-[#3a70ff] text-2xl md:text-3xl font-medium mt-3 md:mt-6">
            {subject}
          </h2>
        )}
      ...
      <Image className="rounded-3xl w-full md:w-[400px]" src={imageSrc} alt={imageAlt} />
    </div>
  );
}
